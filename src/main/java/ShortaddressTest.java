...
public class ShortaddressTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ANTLRInputStream input = new ANTLRInputStream(test.getFile("shortaddressattack.sol"));
        ...
        ShortaddressVisitor myVisitor = new ShortaddressVisitor();
